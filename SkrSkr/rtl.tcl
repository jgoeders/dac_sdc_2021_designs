...
if { $list_projs eq "" } {
   create_project ./RTL/[lindex $argv 0]/RTL -part xczu3eg-sbva484-1-e
}
...
# CHECK IPs
##################################################################
set_property  ip_repo_paths ./VHLS/[lindex $argv 0]/impl/ip [current_project]
update_ip_catalog
...
xilinx.com:hls:skynet_flow:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_clk_wiz, and set properties
  set axi_clk_wiz [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_clk_wiz ]
  ...
  # Create instance: skynet_flow, and set properties
  set skynet_flow [ create_bd_cell -type ip -vlnv xilinx.com:hls:skynet_flow:1.0 skynet_flow ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__OCM_BANK0__POWER__ON {0} \
   CONFIG.PSU__OCM_BANK1__POWER__ON {0} \
   CONFIG.PSU__OCM_BANK2__POWER__ON {0} \
   CONFIG.PSU__OCM_BANK3__POWER__ON {0} \
   ...
   CONFIG.PSU__TCM0A__POWER__ON {0} \
   CONFIG.PSU__TCM0B__POWER__ON {0} \
   CONFIG.PSU__TCM1A__POWER__ON {0} \
   CONFIG.PSU__TCM1B__POWER__ON {0} \
  ...
  connect_bd_intf_net -intf_net S00_AXI_2 [get_bd_intf_pins axi_clk_wiz/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  connect_bd_intf_net -intf_net axi_clk_wiz_M00_AXI [get_bd_intf_pins axi_clk_wiz/M00_AXI] [get_bd_intf_pins clk_wiz/s_axi_lite]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma/M_AXIS_MM2S] [get_bd_intf_pins skynet_flow/in_V]
  ...
  connect_bd_intf_net -intf_net skynet_flow_0_out_r [get_bd_intf_pins axi_dma/S_AXIS_S2MM] [get_bd_intf_pins skynet_flow/out_r]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_clk_wiz/ARESETN] [get_bd_pins rst_ps/interconnect_aresetn]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz/locked] [get_bd_pins rst_clkwiz/dcm_locked]
  connect_bd_net -net rst_ps8_0_375M_peripheral_aresetn [get_bd_pins axi_dma/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clkwiz/peripheral_aresetn] [get_bd_pins skynet_flow/ap_rst_n]
  connect_bd_net -net rst_ps_peripheral_aresetn [get_bd_pins axi_clk_wiz/M00_ARESETN] [get_bd_pins axi_clk_wiz/S00_ARESETN] [get_bd_pins clk_wiz/s_axi_aresetn] [get_bd_pins rst_ps/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma/m_axi_mm2s_aclk] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins clk_wiz/clk_out1] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_clkwiz/slowest_sync_clk] [get_bd_pins skynet_flow/ap_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins axi_clk_wiz/ACLK] [get_bd_pins axi_clk_wiz/M00_ACLK] [get_bd_pins axi_clk_wiz/S00_ACLK] [get_bd_pins clk_wiz/clk_in1] [get_bd_pins clk_wiz/s_axi_aclk] [get_bd_pins rst_ps/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins rst_clkwiz/ext_reset_in] [get_bd_pins rst_ps/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xB0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs clk_wiz/s_axi_lite/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM]
...
make_wrapper -files [get_files ./RTL/[lindex $argv 0]/RTL.srcs/sources_1/bd/ultra96v2/ultra96v2.bd] -top
add_files -norecurse ./RTL/[lindex $argv 0]/RTL.srcs/sources_1/bd/ultra96v2/hdl/ultra96v2_wrapper.v
